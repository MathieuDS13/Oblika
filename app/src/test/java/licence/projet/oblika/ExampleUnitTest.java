...
public class ExampleUnitTest {
    ...
    public void loadingIsCorrect(){
        ...
        for (FixedPlatform fixed :
            ...
            System.out.println("posX " + fixed.getActualPosition().getX() + " posY " + fixed.getActualPosition().getY() + " texture : " + fixed.getTextureId());
        }

        for (MovingPlatform moving :
                level.getMovingPlatformList()) {
            System.out.println("posX " + moving.getActualPosition().getX() + " posY " + moving.getActualPosition().getY() + " texture : " + moving.getTextureId());
        }
